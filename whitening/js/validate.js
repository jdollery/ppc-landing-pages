//https://codepen.io/chriscoyier/pen/VzQXGv
...
;(function (window, document, undefined) {
  ...
  * 1.1.20170427
  *
  * By Eli color-two, http://elicolor-two.com
  * License: Dedicated to the public domain.
  *   See https://github.com/elicolor-two/classList.js/blob/master/LICENSE.md
  */

  /*global self, document, DOMException */

  /*! @source http://purl.elicolor-two.com/github/classList.js/blob/master/classList.js */
  ...
  try {
      ...
      // adding undefined to fight this issue https://github.com/elicolor-two/classList.js/issues/36
...
//   }
  ...
  // If not, create one
  var message = field.form.querySelector('.error-message#' + id + 'Error' );
  if (!message) {
